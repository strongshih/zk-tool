...
/* one claims that he knows:
 * x^3 + x + 5 == 35.
 * return 1 if x is correct 
 * should divided into two entities (verifier and prover)
 * here's just for introduction
 */
extern "C" int test_libsnark (int input_x)
{
